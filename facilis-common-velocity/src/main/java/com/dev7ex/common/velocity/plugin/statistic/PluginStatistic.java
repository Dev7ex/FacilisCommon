...
public class PluginStatistic {
    ...
    public static class Factory {
         ...
         */
        public PluginStatistic make(final Object plugin, final int serviceId) {
            return new PluginStatistic(plugin, this.server, this.logger, this.dataDirectory, serviceId);
        }
    }
